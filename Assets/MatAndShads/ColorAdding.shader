    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            Varyings CombinedShapeLightVertex(Attributes v)
            {
                ...
                // Pass the sprite renderer color directly without multiplying
            ...
            {
                const half4 texColor = SAMPLE_TEXTURE2D(_MainTex, sampler_MainTex, i.uv);
                const half4 mask = SAMPLE_TEXTURE2D(_MaskTex, sampler_MaskTex, i.uv);
                const half4 spriteColor = i.color;
                
                // Add the sprite renderer color to the texture color
                half4 finalColor;
                finalColor.rgb = texColor.rgb + spriteColor.rgb;
                finalColor.a = texColor.a + spriteColor.a;
