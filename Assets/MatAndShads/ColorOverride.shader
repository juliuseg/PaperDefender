Shader "OwnShaders/ColorOverride"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 CombinedShapeLightFragment(Varyings i) : SV_Target
            {
                ...
                // If pixel has any alpha (not transparent), override with target color
                if (main.a > 0)
                {
                    finalColor.rgb = _OverrideColor.rgb;
                    finalColor.a = _OverrideColor.a * main.a; // Blend alpha values
                }
        ...
        Pass
        {
            ...
            float4 UnlitFragment(Varyings i) : SV_Target
            {
                ...
                {
                    finalColor.rgb = _OverrideColor.rgb;
                    finalColor.a = _OverrideColor.a * mainTex.a; // Blend alpha values
                }
